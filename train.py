...
def main() -> None:
    ...
    parser.add_argument("--loss-lambda", type=float, default=0.0,          help="Weight of the MSE calibration term in the profit-aware loss (0 = pure profit, larger = more calibration)")
